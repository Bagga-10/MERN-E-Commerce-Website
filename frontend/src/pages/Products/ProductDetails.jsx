              ...
              <div className="flex items center justify-between w-[20rem]">
                <div className="one">
                  <h1 className="flex items-center mb-6">
                    <FaStore className="text-pink-500 mr-2 " /> Brand:{" "}
                    {product.brand}
                  </h1>
                  <h1 className="flex items-center mb-6">
                  ...
                  <h1 className="flex items-center mb-6 text-indigo-500">
                    <FaStar className="mr-2 " /> Reviews: {product.numReviews}
                  </h1>
                </div>

                <div className="two">
                  <h1 className="flex items-center mb-6 text-yellow-500">
                    <FaStar className="mr-2" /> Ratings:{product.rating}
                  </h1>
                  <h1 className="flex items-center mb-6 text-green-600">
                    <FaShoppingCart className="mr-2" /> Quantity:
                    {product.quantity}
                  </h1>
                  <h1 className="flex items-center mb-6 text-blue-500">
                ...
                {product.countInStock > 0 && (
                  <div>
                    <select
                      ...
                      className="p-2 w-[6rem] rounded-xl text-black border"
                    >
